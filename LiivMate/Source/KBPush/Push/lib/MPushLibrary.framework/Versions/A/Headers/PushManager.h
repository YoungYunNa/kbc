...
#define KEY_CUSTOM_RECEIVER_SERVER_URL                                          @"KEY_CUSTOM_RECEIVER_SERVER_URL" // push 추가
...
typedef void (^PushManagerInterfaceCompletionHandlerWithBody) (BOOL success, NSDictionary *body); // push 추가
...
@property (nonatomic, readonly) NSString *customHost; // push 추가
