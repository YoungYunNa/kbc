...
- (void)setCornersArray:(NSArray *)cornersArray
{
    if (cornersArray.count > 0) {
        NSMutableArray *outerArray = [NSMutableArray arrayWithCapacity:cornersArray.count];
        ...
        _cornersArray = nil;
        _cornersArray = [[NSArray alloc] initWithArray:outerArray];
    } else {
        _cornersArray = nil;
    }
...
- (void)setBorderRectArray:(NSArray *)borderRectArray
{
    if (borderRectArray.count > 0) {
        NSMutableArray *outerArray = [NSMutableArray arrayWithCapacity:borderRectArray.count];
        ...
        _borderRectArray = [[NSArray alloc] initWithArray:outerArray];
    } else {
        _borderRectArray = nil;
    }
