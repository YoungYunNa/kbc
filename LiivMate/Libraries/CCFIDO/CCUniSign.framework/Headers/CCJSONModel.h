...
#import "CCJSONModelError.h"
#import "CCJSONValueTransformer.h"
#import "CCJSONKeyMapper.h"
 ...
 */
@protocol AbstractCCJSONModelProtocol <NSCopying, NSCoding>
 ...
 */
@interface CCJSONModel : NSObject <AbstractCCJSONModelProtocol, NSSecureCoding>
...
+ (void)setGlobalKeyMapper:(CCJSONKeyMapper *)globalKeyMapper DEPRECATED_MSG_ATTRIBUTE("override +keyMapper in a base model class instead");
 ...
 */
- (instancetype)initWithString:(NSString *)string error:(CCJSONModelError **)err;
 ...
 * or a property type in your model is not supported by JSONValueTransformer and its categories
 */
- (instancetype)initWithString:(NSString *)string usingEncoding:(NSStringEncoding)encoding error:(CCJSONModelError **)err;
 ...
 * [CCJSONModelError errorModelIsInvalid] to set the NSError param if the data fails your custom validation
 */
