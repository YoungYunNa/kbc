 ...
 */
#define NETFUNNEL_DEF_HOST              @"m.liivmate.com"

/** 
	Default value for NetFunnel Server Port Number          
*/
#define NETFUNNEL_DEF_PORT              10000

/** 
	Default value for network protocol ( http | https )     
*/
#define NETFUNNEL_DEF_PROTO             @"https"
...
*/
#define NETFUNNEL_DEF_ACTION_ID         @"event"
...
*/
#define NETFUNNEL_DEF_CONN_RETRY        2
